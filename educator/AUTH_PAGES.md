# educator Platform - Authentication Pages

This document describes all authentication-related pages created for the InaWorks educator/employer platform.
...
Similar to:
- **Naukri educator** (naukri.com/educator)
- **Indeed Employer** (employers.indeed.com)
- **LinkedIn educator** (linkedin.com/talent)
