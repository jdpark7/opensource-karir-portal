...
<div class="space-y-6">
	...
	<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
		<div>
			<h1 class="text-2xl md:text-3xl font-bold text-black">Courses</h1>
			<p class="text-muted mt-1">Manage your job postings</p>
		</div>
		<div class="flex gap-3">
			<Button href="/dashboard/courses/inactive/" variant="secondary">
				<Archive class="w-4 h-4" />
				Inactive Courses
			</Button>
			<Button href="/dashboard/courses/new/">
				<Plus class="w-4 h-4" />
				Post New Job
			</Button>
		</div>
	...
	{#if data.courses.length === 0}
		<Card padding="lg" class="text-center">
			...
			<h3 class="text-lg font-semibold text-black mb-2">No courses found</h3>
							...
							<tr class="hover:bg-surface transition-colors">
								<td class="px-6 py-4">
									<div class="flex items-start gap-3">
										...
										<div>
											<a
												href="/dashboard/courses/{job.id}/{job.status === 'Draft' ? '' : 'applicants/'}"
								...
								<td class="px-6 py-4">
									<div class="flex items-center gap-4 text-sm">
										...
										<a
											href="/dashboard/courses/{job.id}/applicants/"
								...
								<td class="px-6 py-4">
									<div class="flex items-center gap-2">
										...
										{#if job.status === 'Draft'}
											<a
												href="/dashboard/courses/{job.id}/edit/"
										...
										<a
											href="/dashboard/courses/new/?copy_from={job.id}"
			...
			{#each data.courses as job}
				<Card hover padding="md">
					...
					<div class="flex items-center gap-2">
						...
						{/if}
						{#if job.status === 'Draft'}
							<Button href="/dashboard/courses/{job.id}/edit/" variant="secondary" size="sm" class="flex-1">
								<Edit class="w-4 h-4" />
								Edit
							</Button>
						{/if}
						<Button href="/dashboard/courses/{job.id}/" size="sm" class="flex-1">
							View
						</Button>
					</div>
				</Card>
	...
	<!-- Pagination -->
	{#if data.courses.length > 0 && (data.next || data.previous)}
		<Card padding="md">
			<div class="flex items-center justify-between">
				<div class="text-sm text-muted">
					Showing {data.courses.length} of {data.count} courses
				</div>
				<div class="flex items-center gap-2">
					<Button
						variant="secondary"
