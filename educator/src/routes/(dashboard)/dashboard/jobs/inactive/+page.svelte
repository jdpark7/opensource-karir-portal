...
<svelte:head>
	<title>Inactive Courses - InaWorks</title>
</svelte:head>
...
<div class="space-y-6">
	...
	<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
		<div class="flex items-center gap-4">
			...
			<div>
				<h1 class="text-2xl md:text-3xl font-bold text-black">Inactive Courses</h1>
	...
	{#if data.courses.length === 0}
		<Card padding="lg" class="text-center">
			...
			<h3 class="text-lg font-semibold text-black mb-2">No inactive courses found</h3>
			<p class="text-muted">
				{searchQuery || selectedFilter !== 'all'
					? 'Try adjusting your filters'
					: 'All your closed and expired courses will appear here'}
			</p>
		</Card>
	{:else}
				...
				<Card hover padding="md">
					<div class="flex items-start justify-between gap-4">
						...
						<div class="flex flex-col gap-2">
							<Button href="/dashboard/courses/{job.id}/" variant="secondary" size="sm">
								<Eye class="w-4 h-4" />
								View
							</Button>
