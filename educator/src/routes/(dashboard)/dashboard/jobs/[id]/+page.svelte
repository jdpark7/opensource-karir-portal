...
<div class="space-y-6">
	...
	<div class="flex flex-wrap gap-3">
		<a
			href="/dashboard/courses/{data.job.id}/applicants/"
		...
		{#if data.job.status === 'Draft'}
			<a
				href="/dashboard/courses/{data.job.id}/edit/"
		...
		<a
			href="/dashboard/courses/{data.job.id}/preview/"
			class="inline-flex items-center gap-2 px-4 py-2 border border-border text-muted rounded-lg hover:bg-surface transition-colors"
		>
			<Eye class="w-4 h-4" />
			Preview
		...
		<a
			href="/dashboard/courses/new/?copy_from={data.job.id}"
			class="inline-flex items-center gap-2 px-4 py-2 border border-border text-muted rounded-lg hover:bg-surface transition-colors"
		>
			<Copy class="w-4 h-4" />
			Copy Job
