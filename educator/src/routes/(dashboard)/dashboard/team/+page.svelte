...
<svelte:head>
	<title>Team Management - InaWorks educator</title>
</svelte:head>
						...
						<div class="flex-1 min-w-0">
							...
							<div class="grid grid-cols-3 gap-4 mt-4">
								<div class="text-center p-3 bg-surface rounded-lg">
									<p class="text-xs text-muted">Courses Posted</p>
									<p class="text-lg font-semibold text-black">{member.stats.courses_posted}</p>
								</div>
								<div class="text-center p-3 bg-surface rounded-lg">
									<p class="text-xs text-muted">Active Courses</p>
									<p class="text-lg font-semibold text-black">{member.stats.active_courses}</p>
								</div>
								<div class="text-center p-3 bg-surface rounded-lg">
				...
				<div class="p-6">
					...
					<div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
						<p class="text-sm text-amber-800">
							⚠️ This member will lose access to all company courses and data. They will become an
