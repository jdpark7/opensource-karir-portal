<script lang="ts">
	...
	// Base navigation items available to all users (Analytics removed)
	const baseNavItems = [
		{ href: '/dashboard/', icon: LayoutDashboard, label: 'Dashboard' },
		{ href: '/dashboard/courses/', icon: Briefcase, label: 'Add Courses' },
					...
					>
						...
						<div class="flex-1 min-w-0 text-left">
							...
							<p class="text-xs text-muted truncate">
								{user?.company?.name || 'Independent educator'}
							</p>
						</div>
