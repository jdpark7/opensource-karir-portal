/**
 * Authentication API for educators
...
/**
 * Register new educator or company account
 */
export async function register(data: RegisterData): Promise<ApiResponse<{ user: User; company: any }>> {
	return ApiClient.post('/educator/auth/register/', data, true);
}
...
export async function login(data: LoginData): Promise<AuthResponse> {
	return ApiClient.post('/educator/auth/login/', data, true);
}
...
export async function logout(): Promise<ApiResponse> {
	return ApiClient.post('/educator/auth/logout/', {});
}
...
export async function verifyEmail(data: VerifyEmailData): Promise<AuthResponse> {
	return ApiClient.post('/educator/auth/verify-email/', data, true);
}
...
export async function resendVerification(email: string): Promise<ApiResponse> {
	return ApiClient.post('/educator/auth/resend-verification/', { email }, true);
}
...
export async function forgotPassword(data: ForgotPasswordData): Promise<ApiResponse> {
	return ApiClient.post('/educator/auth/forgot-password/', data, true);
}
...
export async function resetPassword(data: ResetPasswordData): Promise<ApiResponse> {
	return ApiClient.post('/educator/auth/reset-password/', data, true);
}
...
export async function changePassword(data: ChangePasswordData): Promise<ApiResponse> {
	return ApiClient.post('/educator/auth/change-password/', data);
}
...
export async function acceptInvitation(data: AcceptInvitationData): Promise<AuthResponse> {
	return ApiClient.post('/educator/auth/accept-invitation/', data, true);
}
...
export async function getCurrentUser(): Promise<User> {
	return ApiClient.get('/educator/auth/me/');
}
