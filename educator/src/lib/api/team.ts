/**
 * Team Management API for educators
...
export async function listTeamMembers(): Promise<TeamListResponse> {
	return ApiClient.get('/educator/team/');
}
...
export async function getTeamMember(userId: number): Promise<TeamMemberDetail> {
	return ApiClient.get(`/educator/team/${userId}/`);
}
...
export async function updateTeamMember(
	...
	return ApiClient.patch(`/educator/team/${userId}/update/`, data);
}
...
export async function removeTeamMember(userId: number): Promise<ApiResponse> {
	return ApiClient.delete(`/educator/team/${userId}/remove/`);
}
...
export async function inviteTeamMember(
	...
	return ApiClient.post('/educator/team/invite/', data);
}
...
export async function listInvitations(): Promise<InvitationsListResponse> {
	return ApiClient.get('/educator/team/invitations/');
}
...
export async function resendInvitation(
	...
	return ApiClient.post(`/educator/team/invitations/${invitationId}/resend/`, {});
}
...
export async function cancelInvitation(invitationId: number): Promise<ApiResponse> {
	return ApiClient.delete(`/educator/team/invitations/${invitationId}/cancel/`);
}
