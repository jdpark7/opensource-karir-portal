...
$(document).ready(function () {
  ...
  // $('body').append('<div id="ajaxBusy"><p><img src="http://inaworks.s3.amazonaws.com/static/img/loader-gif.gif" height="60px" width="60px"></p></div>');
  // $('#ajaxBusy').css({
  //     display: "block",
  //     margin: "0px",
  //     paddingLeft: "0px",
    ...
    buttons: [
      {
        ...
        click: function () {
          $(this).dialog("close");
          $.post("/delete-resume/", {}, function (data) {
            if (data.error) {
...
$("#email_notifications").click(function (e) {
  e.preventDefault();
  $.post("/edit_emailnotifications/", {}, function (data) {
    if (data.error == true) {
